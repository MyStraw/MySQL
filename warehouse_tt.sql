...
CREATE TABLE `tt` (
  ...
  `name` varchar(20) COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '',
  `content` varchar(20) COLLATE utf8mb3_unicode_ci DEFAULT 'content',
  PRIMARY KEY (`id`)
...
INSERT INTO `tt` VALUES (103,'a','b'),(104,'c','z'),(105,'e','f');
